...
PROJECTS = [
  ...
  { name: "ccm for tmux", desc: "Attention manager for parallel Claude Code sessions", url: "https://github.com/yohasebe/tmux-ccm", logo: "assets/images/projects/ccm-logo.png", logo_h: 72 },
...
def build_projects_html(root)
  items = PROJECTS.map { |p|
    collab = p[:collab] ? %(\n        <p class="project-collab">#{p[:collab]}</p>) : ""
    <<~ITEM
      <li>
